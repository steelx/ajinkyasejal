...
! function(e) {
    ...
    e(document).ready(function() {
        Lilac = {
            ...
            build: function() {
                var t = this;
                t.preloader(), t.navigation(), t.createMobileMenu(), t.heroHeight(), t.curvedText(), e("input, textarea").placeholder(), t.bgImageGrid(), t.googleMap(), t.createPrettyPhoto(), t.createOwlSliders(), t.parallaxItems(), t.startNiceScroll()
            },
            events: function() {
                var e = this;
